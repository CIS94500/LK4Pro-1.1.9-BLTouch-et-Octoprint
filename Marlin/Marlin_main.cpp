 ...
 *
 * M950 - écran annulation
 * M951 - écran start
 * M952 - écran fini (popup temps print)
 *
 *
 * "T" Codes
 *
...
//VSYS----------------------------------------
    ...
    {
      enqueue_and_echo_commands_P(PSTR("M118 A1 action:pause"));
    }else{      
...
//VSYS----------------------------------------------------------------
    case 2009:
      LGT_LCD.LGT_Change_Page(ID_DIALOG_PRINT_WAIT); 
      delay(5);
      enqueue_and_echo_commands_P(PSTR("G28"));
      enqueue_and_echo_commands_P(PSTR("G29"));
    break;
    case 2010:
      LGT_LCD.LGT_Change_Page(ID_MENU_Z_OFFSET);
    break;
    case 2011:
      LGT_LCD.LGT_Change_Page(ID_UTILI_PID);
      enqueue_and_echo_commands_P(PSTR("M500"));
    ...
    break;
     case 2012:
      ...
      LGT_LCD.LGT_Change_Page(ID_UTILI_FILA_E0);      
    break;
//--------------------------------------------------------------------
#endif // LGT_MAC
