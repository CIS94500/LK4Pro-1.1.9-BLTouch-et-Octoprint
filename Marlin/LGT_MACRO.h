...
//VSYS--------------------------------------
#define ADDR_VAL_FAN_POURCENT               (ADDR_VAL_ICON_HIDE + LEN_WORD)                 // 101A
//------------------------------------------
...
//VSYS--------------------------------------
#define ADDR_VAL_Z_OFFSET                   (0x6400)                                        // 6400

#define ADDR_KPNOZZLE                       (0x6410)                                        // 6410
#define ADDR_KINOZZLE                       (ADDR_KPNOZZLE + LEN_WORD)                      // 6412
#define ADDR_KDNOZZLE                       (ADDR_KINOZZLE + LEN_WORD)                      // 6414
#define ADDR_KPBED                          (ADDR_KDNOZZLE + LEN_WORD)                      // 6416
#define ADDR_KIBED                          (ADDR_KPBED + LEN_WORD)                         // 6418
#define ADDR_KDBED                          (ADDR_KIBED + LEN_WORD)                         // 641A

// filament
#define ADDR_VAL_E0_STEP                    (0x6430)                                        // 6430
...
//VSYS--------------------------------------
  eBT_Z_OFFSET0_PLUS,             //69 0045
  eBT_Z_OFFSET0_MINUS,            //70 0046
  eBT_Z_OFFSET1_PLUS,             //71 0047
  eBT_Z_OFFSET1_MINUS,            //72 0048
  eBT_REFRESH_SD,                 //73 0049
  eBT_AUTO_BED_LEVELING_M500,     //74 004A
  eBT_SAVE_Z_OFFSET,              //75 004B
  eBT_MENU_Z_OFFSET,              //76 004C
  eBT_MENU_Z_OFFSET_EXIT,         //77 004D
  eBT_EEPROM_SAVE,                //78 004E
  eBT_EEPROM_RESTORE,             //79 004F
  eBT_EEPROM_RESET,               //80 0050
  eBT_AUTO_BED_LEVELING_CANCEL,   //81 0051
  eBT_UTILI_PID_NOZZLE,           //82 0052
  eBT_UTILI_PID_BED,              //83 0053
  eBT_HOME_FAN,                   //84 0054
  eBT_PRINT_HOME_FAN,             //85 0055
  eBT_PRINT_HOME_PAUSE_FAN,       //86 0056
  eBT_EXIT_FAN,                   //87 0057
  eBT_UTILI_FILA_E0_PLUS_10,      //87 0058
  eBT_UTILI_FILA_E0_MINI_10,      //88 0059
  eBT_UTILI_FILA_E0_PLUS_1,       //89 005A
  eBT_UTILI_FILA_E0_MINI_1,       //90 005B
  eBT_UTILI_FILA_E0_PLUS_01,      //91 005C
  eBT_UTILI_FILA_E0_MINI_01,      //92 005D
  eBT_UTILI_FILA_E0_PLUS_001,     //93 005E
  eBT_UTILI_FILA_E0_MINI_001,     //94 005F
  eBT_UTILI_FILA_E0_EXTRACT,      //95 0060
  eBT_UTILI_FILA_E0_EXTRACT_CANCEL, //96 0061
  eBT_UTILI_FILA_E0_SAVE,         //97 0062
  eBT_UTILI_FILA_PRESET_COOL      //98 0063
//------------------------------------------
};
...
enum E_MENU_TYPE {
	...
	eMENU_HOME_FILA,        //11 000B
	eMENU_FILE,			        //12 000C
//VSYS--------------------------------------------
  eMENU_LEVELING,         //13 000D
  eMENU_UTILI_Z_OFFSET,   //14 000E
  eMENU_UTILI_PID,        //15 000F
  eMENU_TUNE_Z_OFFSET,    //16 0010
  eMENU_HOME_FAN,         //84 0011
  eMENU_PRINT_HOME_FAN,   //85 0012
  eMENU_PRINT_HOME_PAUSE_FAN, //86 0013
//VSYS--------------------------------------------
};
...
//VSYS---------------------------
#define ID_MENU_TUNE                (2)
#define ID_MENU_UTILITIES           (4)
#define ID_HOME_XY                  (42)
#define ID_HOME_Z                   (43)
#define ID_MENU_Z_OFFSET            (149)
#define ID_WAIT_BED_ABL             (158)
#define ID_UTILITIES_WAIT           (159)
#define ID_UTILI_PID                (160)
#define ID_UTILI_PID_WAIT           (163)
#define ID_HOME_FAN                 (164)
#define ID_UTILI_FILA_E0            (167)
#define ID_UTILI_FILA_E0_HEATINGWAIT (173)
//-------------------------------
