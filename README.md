# LK4Pro-1.1.9-BLTouch-et-Octoprint
# Marlin 3D Printer Firmware
## NOTE

It was based on Marlin 1.1.9 and applies to Longer LKxPro series(same apply to Ux0 Pro series). It set to "LK4 Pro" printer by default. If you want to change to other model, you need unremark related model definition(like "LK5_Pro") in Configuration.h.
